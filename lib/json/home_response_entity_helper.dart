...
homeResponseEntityFromJson(HomeResponseEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = HomeResponseData().fromJson(json['data']);
	}
...
Map<String, dynamic> homeResponseEntityToJson(HomeResponseEntity entity) {
...
homeResponseDataFromJson(HomeResponseData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => HomeResponseDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> homeResponseDataToJson(HomeResponseData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
homeResponseDataDatasFromJson(HomeResponseDataDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeResponseDataDatasToJson(HomeResponseDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
